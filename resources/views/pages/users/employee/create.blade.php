                ...
                <div class="card-body">
                    <form action="{{ route('EmployeeList.store') }}" method="post">
                        ...
                        <div class="form-group"> 
                            ...
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="gender"  value="male" class="custom-control-input"><span class="custom-control-label">Male</span>
                            </label>
                        ...
                        <button class="btn btn-rounded btn-dark">Add</button>
                    </form>
                </div>
